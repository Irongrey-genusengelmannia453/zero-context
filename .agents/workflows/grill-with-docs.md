...
3. Once the scope is locked, physically update the **Active Sprint Goal** and **In Progress** sections in `ROADMAP.md`.
4. If an architectural decision was made (e.g., changing a library or pipeline step), update `ARCHITECTURE.md` or create a local ADR.